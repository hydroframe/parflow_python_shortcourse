...
pfset Cycle.rainrec.0.Length           5
pfset Cycle.rainrec.1.Length           15
...
pfset Patch.z-upper.BCPressure.2.Value	              $rec_flux
pfset Patch.z-upper.BCPressure.3.Value	              $rec_flux
...
set slope_x          [pfload $runname.out.slope_x.pfb]
set slope_y          [pfload $runname.out.slope_y.pfb]
...
for {set i 0} {$i <= 19} {incr i} {
    ...
    pfsave $surface_storage -pfb "surface_storage.$i.pfb"
    ...
    pfsave $water_table_depth -pfb "water_table_depth.$i.pfb"
	...
	pfsave $surface_runoff -pfb "surface_runoff.$i.pfb"
	...
	set filename [format "%s.out.overlandsum.%05d.pfb" $runname $i]
